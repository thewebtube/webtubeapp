...
class SettingsView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.opengithub.setOnClickListener { open_GitHub() }
    ...
    private fun open_GitHub(){
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/thewebtube/webtubeapp"))
        this.startActivity(intent)
    }
